...
export interface CapabilityObservation {
    kind: 'filesystem' | 'network' | 'process' | 'environment' | 'credentials' | 'dynamic-code' | 'native-code' | 'persistence' | 'browser-storage' | 'session-data' | 'clipboard' | 'dynamic-module-loading';
    confidence: AuditConfidence;
    evidence: AuditEvidence[];
}
